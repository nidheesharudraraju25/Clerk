...
export type ComponentControls = {
    ...
    openModal: <T extends 'googleOneTap' | 'signIn' | 'signUp' | 'userProfile' | 'organizationProfile' | 'createOrganization' | 'userVerification' | 'waitlist' | 'blankCaptcha'>(modal: T, props: T extends 'signIn' ? SignInProps : T extends 'signUp' ? SignUpProps : T extends 'userVerification' ? __experimental_UserVerificationProps : T extends 'waitlist' ? WaitlistProps : UserProfileProps) => void;
